 ...
 * are subject to the Apple Public Source License Version 1.1 (the * "License").
...
#define kDataDelay              20       // usec to delay before data is valid
...
private:
    ...
    bool                     _controllerUsesMuxMode;
    UInt8                    _muxModeRoutePrefix;
    
    // Methods that setup controller
    virtual void  detectMuxModeSupport();
    virtual bool  setMuxMode(bool enable);
    virtual void  resetPS2Controller();
    
    // Methods that report interrrupts
    ...
    // Methods that control driver power states
...
public:
    // IOKit methods to start the service
