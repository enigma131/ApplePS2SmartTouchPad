...
#define kDP_SetDefaultsAndDisable      0xF5 // (keyboard+mouse) Disables & defaults(keyboard), Disables only(mouse)
...
//
// Routing prefixes for directing commands to the multiplexed ports(04)
// for the controllers which supports active multiplexing mode in mouse.
//

#define kRP_RoutingPrefixAuxPort            0x90
#define kRP_RoutingPrefixAuxPort1           0x91
#define kRP_RoutingPrefixAuxPort2           0x92
#define kRP_RoutingPrefixAuxPort3           0x93
...
/*
 * Every command or data byte sent to the mouse (except for the resend command fe) is ACKed with fa.
 * If the command or data is invalid, it is NACKed with fe. 
 * If the next byte is again invalid, the reply is ERROR: fc.
 */

#define kSC_Resend              0xFE    // No Acknowledge / request to resend cmd
#define kSC_Error               0xFC    // error status
#define kSC_Acknowledge         0xFA    // ack for transmitted commands
#define kSC_Reset               0xAA    // the keyboard/mouse has reset
#define kSC_Mouse_Ret_ID        0x00    // the mouse has returned id
...
//
//Defines the Keyboard Notification Handler registered by a PS/2 device driver to
//notify the keypress events on the PS/2 Controller, and to manage the fn key funtions
//accordingly
typedef  void (*FnKeysAction)(void * target, UInt32 data);
...
enum touchpad {
    kPS2C_ShiftKey,
    kPS2C_Gesture_AppSwitch,        // App Switch with menu, cmd+tab, 1
    kPS2C_Gesture_AppClose,         // App Close, 2
    kPS2C_Gesture_Launchpad,        // Launchpad, 131(0x83), 3
    kPS2C_Gesture_MissionControl,   // Mission Control, 160(0xA0), 4
    kPS2C_Gesture_Dashboard,        // Dashboard, 130(0x82), 5
    kPS2C_Gesture_DesktopSwitchLeft,    // Desktop/Full Screen Apps switch to previous, CNTRL + LEFT , 6
    kPS2C_Gesture_DesktopSwitchRight,   // Desktop/Full Screen Apps switch to next, CNTRL + RIGHT, 7
    kPS2C_Gesture_AppWindows,           // Application Windows, CNTRL + DOWN, 8
    kPS2C_Gesture_Minimize,     // Minimize App, CMD + M, 9
    kPS2C_Gesture_FullScreen,   // Full Screen Switch, CMD + CNTRL + F, 10
    kPS2C_Gesture_Backward,     // Backward, CMD + [, 11
    kPS2C_Gesture_Forward,      // Forward, CMD + ], 12
    kPS2C_Gesture_Desktop,      // Desktop, F11, 13
    kPS2C_Gesture_NC_Shortcut,  // Notification Centre, 14
    kPS2C_Gesture_GetInfo,      // Show Info, 15
    kPS2C_Gesture_ToggleDock,   // Hide/Show Dock, 16
    kPS2C_Gesture_NC_Workaround,// Soft NC, 17
    kPS2C_Gesture_ZoomReset,    // Zoom reset, 18
    kPS2C_Gesture_Finder,       // Finder, 19
    kPS2C_Gesture_ForceQuit,    // Force Quit, 20
    kPS2C_ExtFunF13,
    kPS2C_ExtFunF14,
    kPS2C_ExtFunF15,
    kPS2C_ExtFunF16,
    ...
    kPS2C_ExtFunF23,
    kPS2C_ExtFunF24,
    kPS2C_Gesture_ContextMenu,  // Right Click, 33
    kPS2C_Gesture_MiddleClick,  // Middle click, 34
    kPS2C_Gesture_LeftClick,    // Left click, 35
    kPS2C_EnableTouchpad,
    kPS2C_DisableTouchpad,
    kPS2C_AccidentalInput,
    kPS2C_DoContextMenu,
    kPS2C_ZoomPlus,
    kPS2C_ZoomMinus,
    kPS2C_ZoomReset,
    ...
    kPS2C_RotateRight,
    kPS2C_ReleaseCmdKey,
    kPS2C_ScrollLock_Auto,
    kPS2C_ScrollLock_Inertia,
    kPS2C_ScrollLock_Continuous,
    kPS2C_EdgeScroll,
    kPS2C_Gestures_1FSwipes,
    kPS2C_Gestures_3FSwipes,
    kPS2C_Gestures_4FSwipes,
    kPS2C_Gestures_Rotate,
    kPS2C_Gestures_Zoom,
    kPS2C_Gestures_DoubleTaps,
    kPS2C_FnKey_Modes,
    kPS2C_ESC,
    kPS2C_ALT_Funtion_on,
    kPS2C_ALT_Funtion_off,
    kPS2C_CNTRL_Feature_on,
    kPS2C_CNTRL_Feature_off,
    kPS2C_CNTRLKeyDown,
    kPS2C_CNTRLKeyUp,
    kPS2C_CMDKeyDown,
    kPS2C_CMDKeyUp,
    kPS2C_InitKeyboard,
    kPS2C_EnableAsusKBacklight,
    kPS2C_EnableAsusKBacklight16Levels,
    kPS2C_RestoreTouchpad,
    kPS2C_KeybrdBackLightOff,
    kPS2C_KeybrdBackLightOn,
    kPS2C_KeybrdBackLightToggleOn,
    kPS2C_KeybrdBackLightToggleOff,
    kPS2C_ShowTouchPressureWidth,
    kPS2C_BrightnessDown,
    kPS2C_BrightnessUp,
    kPS2C_OSXVersionNotify
};
